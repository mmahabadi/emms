        ...
        <div className='card shadow-none w-100'>
          ...
          <div className='card-header' id='kt_explore_header'>
            <h5 className='card-title fw-bold text-gray-600'>
              Explore {process.env['NX_REACT_APP_THEME_NAME']}
            </h5>
            ...
            >
              <div className='mb-7'>
                <div className='d-flex flex-stack'>
                  <h3 className='mb-0'>{process.env['NX_REACT_APP_THEME_NAME']} Licenses</h3>
              ...
              <a href={process.env['NX_REACT_APP_BOOTSTRAP_DOCS_LINK']} className='btn btn-primary mb-15 w-100'>
                Buy Now
              </a>
              <Demos />
            </div>
