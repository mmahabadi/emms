...
import {saveSkill} from "../../core/services";
...
export const SkillEntryForm: FC = () => {
  const intl = useIntl();
  ...
  const onSubmit: SubmitHandler<Skill> = async (values) => {
    const entry = mapFormValues<Skill>(values);
    setLoading(true);
    try {
